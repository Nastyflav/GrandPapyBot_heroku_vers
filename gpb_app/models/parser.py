...
class Parser:
    ...
    def __init__(self, textinput):
        self.greetings = ['bonjour', 'salut', 'hello', 'coucou', 'grandpy', 'papy', 'vieux bougon', 'papi']
        self.keywords = ['adresse', 'lieu', 'rue', 'ville', 'donner', 'coordonnées', 'plait']
        ...
        self.textinput = str(textinput).casefold()  #converts into lower cases and removes all case distinctions

        self.stop.extend(self.greetings)
        self.stop.extend(self.keywords)
